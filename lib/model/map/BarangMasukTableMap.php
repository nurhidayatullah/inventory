...
class BarangMasukTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addForeignKey('ID_SUPPLIER', 'IdSupplier', 'INTEGER', 'supplier', 'ID', false, 11, null);
    ...
    $this->addRelation('DetailBarangMasuk', 'DetailBarangMasuk', RelationMap::ONE_TO_MANY, array('id' => 'id_barang_masuk', ), 'CASCADE', 'CASCADE');
	} // buildRelations()
