...
abstract class BaseCustomersPeer
{
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (CustomersPeer::ID, CustomersPeer::NAMA_CUST, CustomersPeer::ALAMAT, CustomersPeer::ID_KOTA, CustomersPeer::TELP, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAMA_CUST', 'ALAMAT', 'ID_KOTA', 'TELP', ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (CustomersPeer::ID => 0, CustomersPeer::NAMA_CUST => 1, CustomersPeer::ALAMAT => 2, CustomersPeer::ID_KOTA => 3, CustomersPeer::TELP => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAMA_CUST' => 1, 'ALAMAT' => 2, 'ID_KOTA' => 3, 'TELP' => 4, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn($alias . '.nama_cust');
    ...
    {
        // Invalidate objects in TransaksiPeer instance pool,
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        try {
            ...
            $c = clone $criteria;
            $affectedRows += CustomersPeer::doOnDeleteCascade($c, $con);
