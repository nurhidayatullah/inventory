...
abstract class BaseCustomersPeer {
	...
	/** the column name for the NAMA_CUST field */
	const NAMA_CUST = 'customers.NAMA_CUST';

	/** the column name for the ALAMAT field */
	const ALAMAT = 'customers.ALAMAT';

	/** the column name for the ID_KOTA field */
	const ID_KOTA = 'customers.ID_KOTA';

	/** the column name for the TELP field */
	const TELP = 'customers.TELP';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'NamaCust', 'Alamat', 'IdKota', 'Telp', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'namaCust', 'alamat', 'idKota', 'telp', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAMA_CUST, self::ALAMAT, self::ID_KOTA, self::TELP, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'nama_cust', 'alamat', 'id_kota', 'telp', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'NamaCust' => 1, 'Alamat' => 2, 'IdKota' => 3, 'Telp' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'namaCust' => 1, 'alamat' => 2, 'idKota' => 3, 'telp' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAMA_CUST => 1, self::ALAMAT => 2, self::ID_KOTA => 3, self::TELP => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'nama_cust' => 1, 'alamat' => 2, 'id_kota' => 3, 'telp' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CustomersPeer::NAMA_CUST);
		$criteria->addSelectColumn(CustomersPeer::ALAMAT);
		$criteria->addSelectColumn(CustomersPeer::ID_KOTA);
		$criteria->addSelectColumn(CustomersPeer::TELP);
	}
	...
	{
		// invalidate objects in TransaksiPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	public static function doCountJoinKota(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(CustomersPeer::ID_KOTA, KotaPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Customers objects pre-filled with their Kota objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinKota(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		CustomersPeer::addSelectColumns($criteria);
		$startcol = (CustomersPeer::NUM_COLUMNS - CustomersPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Customers) to $obj2 (Kota)
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		CustomersPeer::addSelectColumns($criteria);
		$startcol2 = (CustomersPeer::NUM_COLUMNS - CustomersPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Customers) to the collection in $obj2 (Kota)
				$obj2->addCustomers($obj1);
    ...
    foreach (sfMixer::getCallables('BaseCustomersPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseCustomersPeer', $values, $con))
      {
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(CustomersPeer::ID, $criteria->remove(CustomersPeer::ID), $comparison);
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += CustomersPeer::doOnDeleteCascade(new Criteria(CustomersPeer::DATABASE_NAME), $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			$affectedRows += CustomersPeer::doOnDeleteCascade($criteria, $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		$objects = CustomersPeer::doSelect($criteria, $con);
		foreach ($objects as $obj) {


			// delete related Transaksi objects
			$criteria = new Criteria(TransaksiPeer::DATABASE_NAME);
			
			$criteria->add(TransaksiPeer::ID_CUSTOMERS, $obj->getId());
			$affectedRows += TransaksiPeer::doDelete($criteria, $con);
		}
		return $affectedRows;
	}
